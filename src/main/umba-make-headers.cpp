/*! \file
    \brief Главный файл приложения umba-make-headers. Подсасывает сорс из соседней репы или генерирует стаб, сообщающий, что сорс подтянуть не вышло. Используется #if __has_include("")
*/
